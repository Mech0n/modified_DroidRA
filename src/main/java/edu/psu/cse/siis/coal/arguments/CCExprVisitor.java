...
public class CCExprVisitor implements JimpleValueSwitch {
  ...
  protected void dbg0(String what, Value v) {
    System.out.println("DBG:ccExprVisitor." + what + " v=" + v + " class= " + v.getClass().getName()
  ...
  public void caseStaticInvokeExpr(StaticInvokeExpr v) {
    ...
    if (dbg_all_string_functions_known) {
      System.out.println("DBG:rop-expected-Invoke at " + stmt + " found " + v + "  of class= "
  ...
  public void defaultCase(Object o) {
    System.out.println("DBG:ccExprVisitor.defaultCase" + o + " class= " + o.getClass().getName());
  }
